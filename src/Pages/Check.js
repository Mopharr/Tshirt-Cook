    ...
    <Main>
                  ...
                  <div>
                    <div className="delivery-content-inner">
                      ...
                      <p>
                        ...
                        the IPOB leader court hearing, orders will be delayed to
                        the following affected state;
                        ...
                        - You will experience elongated timelines on your Jumia
                        Global orders, this is because of the Chinese New Year.
                        <br />
                        - Large items (e.g. Freezers) may arrive 2 business days
                        later than other products. <br />
            ...
            <div className="amount-overview">
              ...
              <div className="total"> 
                ...
                <div className="total-value">
                  <span data-currency-iso="NGN">₦</span> 
                  <span dir="ltr" data-price="5980">5,980</span> 
                </div>
              </div>
            </div>
            <div className="hint">
      ...
      <aside>
        ...
        <section className="item-box">
          ...
          <a className="colp" href="https://www.jumia.com.ng/cart/">Modify Cart</a></div>
        </section>
      </aside>
    </Main>
  );
